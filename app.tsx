...
function CrashesDashboard({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "tab-bar"
  }, ['summary', 'timeline'].map(tab => /*#__PURE__*/React.createElement("div", {
    key: tab,
    className: `tab ${activeTab === tab ? 'active' : ''}`,
    onClick: () => setActiveTab(tab)
  }, tab === 'summary' ? 'Event Summary' : 'Event Timeline'))), activeTab === 'summary' && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexWrap: 'wrap',
      gap: '12px',
  ...
  }, formatBytes(c.size))))), /*#__PURE__*/React.createElement(CollapsibleFileList, {
    files: sectionFiles,
    selectedFile: selectedFile,
    setSelectedFile: setSelectedFile
  }));
...
const sectionConfig = [{
  ...
  title: 'Networking',
  icon: '🌐',
  prefixes: ['logs/Networking/', 'logs/NetworkRelay/', 'WiFi/'],
...
function SectionComponent({
  ...
  if (config.id === 17) {
    ...
    sectionConfig.slice(0, 16).forEach(c => {
